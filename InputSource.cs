...
namespace NintendoSpy
{
    public class InputSource
    {
        ...
        static public readonly InputSource PC360 = new InputSource ("pc360", "[xinput] PC 360", 0x02, _ => new XInputReader ());
        static public readonly InputSource PAD = new InputSource ("generic", "[dinput] PC Gamepad", 0x04, _ => new GamepadReader ());
